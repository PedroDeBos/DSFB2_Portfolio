...
Using the SQL script shown in the screenshot below, a SQL database has been created called "workflowsdb". Now, using RPostgreSQL, the created datasets will be inserted into this database
