...
Now, with this fully joined dataset, we'll perform some data visualisations. For this, we'll be focussing on the 2002-2015 area, since this contains data for gapminder, flu AND dengue data.

```{r}
data_relevant<-data_full %>% filter(year >=2002 & year <=2015)
```
