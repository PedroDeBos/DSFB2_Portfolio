...
```{r}
list(gapminder_countries=gapminder$country %>% unique,
     dengue_countries=dengue$country %>% unique,
     flu_countries=flu$country %>% unique)
```

In the countries, we can see a way wider spread of countries. Gapminder contains data of over 180 countries, while flu has 30 and dengue has 10. In order to create a full, properly joined dataset we will filter all 3 datasets to only contain shared years and shared countries
