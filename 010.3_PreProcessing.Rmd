...
What's nice about caret training is that it contains pre-built in preprocessing methods. For example: 
...
centering and scaling the data already increases the accuracy of the system, making it detect the versicolor originally classified as a virginica as the correct species. However, the question remains: what other forms of pre-processing are available? And when do you need to use which form of pre-processing?
