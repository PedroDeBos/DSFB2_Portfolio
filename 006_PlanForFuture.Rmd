...
Lastly, I could also spent this time starting my learning journey in Python. With this, I could both study automisation and, perhaps more importantly, start on studying how machine learning works. A tutorial for python can, for example, [be found here](https://automatetheboringstuff.com/)
