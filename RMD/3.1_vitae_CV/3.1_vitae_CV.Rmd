...
tribble(
  ...
  "Comfortable with making figures, performing statistical tests, simple analysises (RNAseq, metagenomics). Portfolio is available on pedrodebos.github.io", "R [x][x][x][.][.]",
