...
````{r addingAnImage, out.width = "20%", fig.align='right', echo=FALSE}
...
tribble(
  ...
  "Comfortable with making figures, performing statistical tests, simple analysises (RNAseq, metagenomics)", "", "R [x][x][x][.][.]", "",
