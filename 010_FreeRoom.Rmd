...
Thus, we can conclude: pre-processing is _not_ always beneficial if done without knowledge of what the pre-processing does. Does, this will be the next thing we focus on: What kinds of pre-processing exist?